...
/**
 * Servlet implementation class Cassandra4DisplayQueryResultsLimit
 */
@WebServlet("/displayLimit")
public class Cassandra4DisplayQueryResultsLimit extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Cassandra4DisplayQueryResultsLimit() {
        super();
